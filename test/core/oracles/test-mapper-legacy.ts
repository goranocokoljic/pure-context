/**
 * LEGACY ORACLE (Phase 104, Task 648) — the pre-1.37 test mapper, kept for
 * ONE release as the parity oracle for the tokenizing mapper in
 * src/core/test-mapper.ts. Not shipped; test-only. Delete in 1.38.
 *
